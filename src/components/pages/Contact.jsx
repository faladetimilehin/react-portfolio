...
import homeImage from '../../assets/timmy.jpg'
        ...
        <div className="container">
          <div className="row justify-content-md-center">
            <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
              ...
              <h2 className="display-5 mb-4 mb-md-5 text-center"> You can get in touch with me by filling this form.</h2>
        ...
        <div className="container">
          <div className="row gy-3 gy-md-4 gy-lg-0 align-items-xl-center">
            <div className="col-12 col-lg-6 ">
              <Image src={homeImage} width={1000} alt='computer' />
            </div>
            <div className="col-12 col-lg-6">
